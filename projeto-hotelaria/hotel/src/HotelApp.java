...
public class HotelApp extends Application {
    ...
    private Tab abaQuartos() {
        ...
        bloquear.setOnAction(e -> {
            ...
            q.bloquear();
            atualizarTudo();
            tabelaQuartos.getSelectionModel().select(q);                          //  novo
            info("Quarto " + q.getNumero() + " bloqueado para manutenção.");      //  novo
        });
        ...
        liberar.setOnAction(e -> {
            ...
            atualizarTudo();
            tabelaQuartos.getSelectionModel().select(q);                              //  novo
            info("Quarto " + q.getNumero() + " liberado e disponível novamente.");    //  novo
        });
    ...
    private Tab abaReservas() {
        ...
        saida.setPrefWidth(140);

        Button criar = new Button("Criar reserva");
        criar.setPrefWidth(160);
        criar.setOnAction(e -> {
